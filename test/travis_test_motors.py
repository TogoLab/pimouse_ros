...
class MotorTest(unittest.TestCase):
	...
	def test_on_off(self):
		...
		ret = off()
		self.assertEqual(ret.success, True, "motor off does not sicceeded")
		...
		on = rospy.ServiceProxy('/motor_on',Trigger)
		ret = on()
		self.assertEqual(ret.success, True, "motor on does not sicceeded")
